...
<module external.linked.project.id=":react-native-code-push" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../../android/app" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
